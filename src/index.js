...
class Code {
  ...
  /**
   * Allow Code to be converted to/from other blocks
   */
  static get conversionConfig() {
    return {
      /**
       * To create Code data from string, simple fill 'text' property
       */
      import: 'text',
      /**
       * To create string from Code data, concatenate text and caption
       * @param {CodeData} codeData
       * @return {string}
       */
      export: function (codeData) {
        return codeData.caption ? `${codeData.text} — ${codeData.caption}` : codeData.text;
      }
    };
  }
  ...
  */
   ...
   */
  render() {
    const container = this._make('code', [this.CSS.baseClass, this.CSS.wrapper, this.CSS.langClass], {
